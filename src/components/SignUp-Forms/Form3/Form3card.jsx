...
return (
    ...
    <div className={styles.box1}>
        ...
        <Body2 className={styles.body1}>Spend most of the day sitting (e,g., bankteller, desk job)</Body2>
    </div>
    <div className={styles.box2}>
        <Body1 className={styles.body1}>Lightly Active</Body1>
        <Body2 className={styles.body1}>Spend a  good part of the day on your feet (e.g,  teacher, salesperson)</Body2>
    </div>
    <div className={styles.box3}>
        <Body1 className={styles.body1}>Active</Body1>
        <Body2 className={styles.body1}>Spend a good part of the day doing physical activity (e.g,  food server, postal courier)</Body2>
    </div>
    <div className={styles.box4}>
        <Body1 className={styles.body1}>Very Active</Body1>
        <Body2 className={styles.body1}>Spend a good part of the  day doing heavy physical activity (e.g,  bike messanger, carpenter)</Body2>
    </div>
    <div>
